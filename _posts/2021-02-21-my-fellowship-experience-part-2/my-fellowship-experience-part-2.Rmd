...
**Spreadsheets** <br>
  In my role, I work with Excel and Google Sheets extensively. I mean everyday, multiple times a day. I have noticed that my job prefers Google Sheets. Almost all of the dashboards I interact with are built in Google Sheets(others are in Data Studio) and much of the reports I submit are in Google Sheets. I have never had a role where I had to use spreadsheets so much before and it has been a learning experience. I decided to learn more shortcuts and formulas via the [Google Sheets - The Comprehensive Masterclass](https://www.udemy.com/course/google-sheets-masterclass/) course on Udemy that will enhance my workflow with spreadsheets. A goal of mine is to try and make a dashboard in Google Sheets. 
